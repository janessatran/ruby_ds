...
describe '#bubble_sort_by' do
  ...
  # we can use the yield function to change functionality of the sort
  # this is useful for comparing objects, since the comparison
  # would depend on something the creator defines
